...
<!-- TCT not resorbed in the cell? Is this published? -->

<!-- TCT in specificity? Do similar Vibrios release TCT? Does it work? -->

TCT plays a key role in signaling to multiple host phenotypes, is sufficient to recapitulate many of the above phenotypes (although not always to the full effect), and likely contributes to the specificity of the host responses observed upon *V. fischeri* colonization. However, there are other bacterial and host compounds that have been characterized for their role in signaling and these are summarized below.
...
Brennan - additional role for flagella in generating OMVs and communicating with the host, suggesting an intriguing coordination between flagellar swimming and signaling between the symbiont and the host innate immune system.
